...
grep_syntax_spec: list[SyntaxSpecification] = [
    [
        [
            ...
            String(flag="-e", alias=["--regexp"], arity=Arity.ONE_OR_MORE),
            Path(flag="-f", alias=["--file"], arity=Arity.ONE_OR_MORE),
            ...
            Flag("-c", alias=["--count"]),
            Selection(flag="--color", alias=["--colour"], choices=("never", "always", "auto")),
            ...
            String(flag="--group-separator"),
            Flag("--no-group-separator"),
            Flag("-a", alias=["--text"]),
            Selection(flag="--binary-files", choices=("binary", "text", "without-match")),
            Selection(flag="-D", alias=["--devices"], choices=("read", "skip")),
            Selection(flag="-d", alias=["--directories"], choices=("read", "skip", "recurse")),
            Glob(flag="--exclude"),
        ...
        [String(arity=Arity.EXACTLY_ONE), Path(arity=Arity.ZERO_OR_MORE)],
    ]
]
