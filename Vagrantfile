Vagrant.configure("2") do |config|
  ...
  # Reguar ubuntu testing box with LVM
  config.vm.define "ubuntulvm" do |ubuntulvm|
    ubuntulvm.vm.box = "generic/ubuntu2204"
    ubuntulvm.vm.provision "file", source: "./", destination: "/home/vagrant/try"
    ubuntulvm.vm.provision "shell", privileged: false, inline: "
      sudo apt update
      sudo apt install -y git expect lvm2 mergerfs
