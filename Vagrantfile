Vagrant.configure("2") do |config|
  ...
  config.vm.define "debian" do |debian|
    ...
    debian.vm.provision "shell", inline: "bash /home/vagrant/try/run_tests.sh"
  end
  ...
  config.vm.define "arch" do |arch|
    ...
    arch.vm.provision "shell", inline: "bash /try/test/run_tests.sh"
  end
  ...
  config.vm.define "rocky" do |rocky|
    ...
    rocky.vm.provision "shell", inline: "bash /home/vagrant/try/run_tests.sh"
  end
end
